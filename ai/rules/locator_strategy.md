...
- Playwright: `ai/rules/playwright_rules.md` (Section 3) — *chưa có trong project này*
- Selenium: `ai/rules/selenium_rules.md` (Section 1)
- Appium: `ai/rules/appium_rules.md` (Section 1)
