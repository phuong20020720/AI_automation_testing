...
> - **Skill:** `smart_locator_agent` (nạp qua công cụ Skill) — Quy trình sinh locator
> - **Skill:** `ui_debug_agent` (nạp qua công cụ Skill) — Quy trình inspect DOM
...
2. **Xác định framework và đọc rules tương ứng:**
   ...
   | Framework | Rule file |
   |-----------|-----------|
   | Playwright | `ai/rules/playwright_rules.md` |
   | Selenium | `ai/rules/selenium_rules.md` |
   | Appium | `ai/rules/appium_rules.md` |
