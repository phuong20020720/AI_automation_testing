...
> **BẮT BUỘC (MANDATORY SKILL):** Bạn PHẢI nạp và đọc kỹ nội dung của skill **`requirements_analyzer`** (nạp qua công cụ Skill — tự resolve theo tên) để hiểu cách phân tích yêu cầu chuẩn trước khi bắt đầu.
